...
!function ($) {
    ...
    MainApp.prototype.initSlimscroll = function () {
        ...
        MainApp.prototype.activateMenuItem = function () {
            ...
            function readFixUriPath(uri){
                var built_path_name = '';
                if (uri != ''){
                    var split_path_name = uri.split('/');
                    if (split_path_name.length > 2) {
                        built_path_name = split_path_name[1] +'/'+ split_path_name[2];
                    } else {
                        built_path_name = window.location.pathname;
                    }
                } 
                return built_path_name;
            }
        },
