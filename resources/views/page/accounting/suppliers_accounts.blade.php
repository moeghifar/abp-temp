...
@if($page == "view" && $id == null)
    @section('title', 'Suppliers Accounts')
    @section('page_title', 'Suppliers Accounts')
                ...
                <div class="panel panel-primary">
                    <div class="panel-body">
                        <div class="m-b-30 m-t-0">
                            <a href="/accounting/suppliers_accounts/add" class="btn btn-success waves-effect waves-light" ><i class="mdi mdi-plus"></i> Add Suppliers Accounts Records</a>
                        </div>
                ...
                <div class="panel-body">
                    <form id="formContainer">
                        <div class="form-group">
                            <label for="input2">Suppliers Name</label>
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <div class="input-group">
                                    <input type="text" name="date" class="form-control" placeholder="Payment Date" id="datepicker-autoclose" required>
