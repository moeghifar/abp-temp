                ...
                <div class="panel panel-primary">
                    <div class="panel-body">
                        <div class="m-b-30 m-t-0">
                            <a href="/accounting/asset/add" class="btn btn-success waves-effect waves-light" ><i class="mdi mdi-plus"></i> Add New Asset</a>
                        </div>
                ...
                <div class="panel-body">
                    <form id="formContainer">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="sales_number" placeholder="Name" required>
                            <small></small>
                        </div>
                        <div class="row">
                            <div class="col-md-7">
                                <div class="form-group">
                                    <label for="input2">Group</label>
                        ...
                        <div class="form-group">
                            <label for="input1">Residual Value</label>
                            <input type="text" class="form-control" name="sales_number" placeholder="Residual Value" required>
                        </div>
                        <div class="form-group">
                            <label for="input1">Lifetime (years)</label>
                            <input type="text" class="form-control" name="sales_number" placeholder="Lifetime" required>
                        </div>
                        <div class="form-group">
                            <label for="input1">Account Depreciation</label>
                            <input type="text" class="form-control" name="sales_number" placeholder="Account Depreciation" required>
                        </div>
                        <div class="form-group">
                            <label for="input1">Depreciation Expense</label>
                            <input type="text" class="form-control" name="sales_number" placeholder="Depreciation Expense" required>
                        </div>
