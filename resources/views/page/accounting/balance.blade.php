...
@if($page == "view" && $id == null)
    @section('title', 'Set Balance')
    @section('page_title', 'Set Balance')
                ...
                <div class="panel panel-primary">
                    <div class="panel-body">
                        <div class="m-b-30 m-t-0">
                            <a href="/accounting/balance/add" class="btn btn-success waves-effect waves-light" ><i class="mdi mdi-plus"></i> Add New Balance</a>
                        </div>
