...
@section('page_title', 'Sales Invoice Data')
                ...
                <div class="panel panel-primary">
                    <div class="panel-body">
                        <div class="m-b-30 m-t-0">
                            <button id="btnAction" data-action="add" type="button" class="btn btn-success waves-effect waves-light" ><i class="mdi mdi-plus"></i> Add Sales Invoice</button>
                        </div>
...
@push('custom_js')
    <script>
        ...
        common.outputColumn = ["result_invoice","sales_invoice_name","sales_invoice_phone","sales_invoice_address","result_action"];
