...
@section('page_title', 'Sales Return Data')
...
@section('content')
                ...
                <div class="panel panel-primary">
                    <div class="panel-body">
                        <div class="m-b-30 m-t-0">
                            <button id="btnAction" data-action="add" type="button" class="btn btn-success waves-effect waves-light" ><i class="mdi mdi-plus"></i> Add Sales Return</button>
                        </div>
    ...
    @else
    Sales return Id : {{ $sales_return_id }}
    @endif
    <!-- BOF modal with form -->
...
@push('custom_js')
    <script>
        ...
        common.urlAdd       = '/api/v1/sales/return/add';  
        common.outputColumn = ["result_return","sales_return_name","sales_return_phone","sales_return_address","result_action"];
